...
# Load the model and vectorizer from the model registry mlflow tool
...
# Load the model and vectorizer from the local storage
...
# Initialize the model and vectorizer, use below code when using model from local storage
model, vectorizer = load_model("./lgbm_model.pkl", "./tfidf_vectorizer.pkl")  

# Initialize the model and vectorizer, use below code when using model from mlflow model registry
